package dorkbots_sound_example.app.view.views
{
	...
	import com.dayvid.effects.fireworks.Fireworks;
	import com.dayvid.mvc.ISpriteView;
	import com.dayvid.ui.DragObject;
	import com.dayvid.ui.scrollbars.ScrollBarHorizontal;
	import com.dayvid.ui.scrollbars.ScrollBars;
	...
	import dorkbots_sound_example.sound.MusicList;
	import dorkbots_sound_example.sound.SoundFXList;
	import dorkbots_sound_example.sound.VoiceOverList;

	public class SoundExampleView extends SoundExample_MC implements ISpriteView
	{
		...
		public function SoundExampleView()
		{
			//trace("SoundExampleView");
		}
